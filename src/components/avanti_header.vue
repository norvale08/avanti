  ...
  <header class="app-header">
    <div class="header-inner">
      ...
      <div class="logo">
        ...
        />
        <svg v-if="logoFallback" class="logo-icon" viewBox="0 0 44 24" fill="currentColor">
          <path d="M0 8 h26 v-4 l18 8 l-18 8 v-4 h-26 z" />
        </svg>
      ...
      <nav class="nav-links">
        ...
        <router-link class="nav-link" active-class="active" to="/documenti">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/>
          </svg>
          Documenti
        </router-link>
        <router-link class="nav-link" active-class="active" to="/profilo">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
.app-header {
  ...
  border-bottom: 1px solid hsla(240, 6%, 90%, 1);
  opacity: 1;
}
