<template>
  <nav class="mobile-nav" aria-label="Mobile navigation">
    ...
    <router-link class="nav-item" active-class="active" to="/documenti">
      <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/>
      </svg>
      <span class="nav-label">Documenti</span>
    </router-link>
    <router-link class="nav-item" active-class="active" to="/profilo">
      <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <a class="nav-item support">
      <img class="nav-icon" src="/Chat%20icon.png" alt="Chat" />
...
.mobile-nav {
  ...
  border-top: 1px solid hsla(240, 6%, 90%, 1);
  z-index: 100;
}
